 ...
 * @author ingohuyy
 */
public class FlightMockGenerator implements FlightSearch {
    ...
    public FlightMockGenerator(String filename) {
    ...
    public static void main(String args[]) {
        FlightMockGenerator generator = new FlightMockGenerator("airportCodes.txt");
